...
type UnifiedGroupSource struct {
    DataSource
    // The group property
    group i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable
...
func (m *UnifiedGroupSource) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["group"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.CreateGroupFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetGroup(val.(i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable))
        }
        return nil
    }
...
func (m *UnifiedGroupSource) GetGroup()(i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable) {
    return m.group
}
...
func (m *UnifiedGroupSource) SetGroup(value i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable)() {
    m.group = value
}
...
type UnifiedGroupSourceable interface {
    ...
    GetGroup()(i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable)
    GetIncludedSources()(*SourceType)
    SetGroup(value i1459bb6cc24e946b3ac09fa3a3fb09be20240c61da91d0d77300a3654d193206.Groupable)()
